...
import com.khacchung.makevideo.databinding.RowFilterViewBinding;
...
public class FilterViewAdapter extends RecyclerView.Adapter<FilterViewAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        RowFilterViewBinding binding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext())
                , R.layout.row_filter_view, parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(RowFilterViewBinding binding) {
            super(binding.getRoot());
            mImageFilterView = binding.imgFilterView;
            mTxtFilterName = binding.txtFilterName;
